...
class UpdateStudyMaterialUseCase {
  ...
  Future<Either<Failure, StudyMaterialEntity>> call(UpdateStudyMaterialParams params) async {
    // Input validation
    ...
    return existingResult.fold(
      ...
      (existingMaterial) async {
        ...
        final updatedMaterial = existingMaterial.copyWith(
          ...
          originalContentText: params.originalContentText ?? existingMaterial.originalContentText,
          fileStoragePath: params.fileStoragePath ?? existingMaterial.fileStoragePath,
          ocrExtractedText: params.ocrExtractedText ?? existingMaterial.ocrExtractedText,
